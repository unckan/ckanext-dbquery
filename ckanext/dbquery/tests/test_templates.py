...
class TestDBQueryTemplates:
    ...
    def test_queries_template(self, app, sysadmin_user, mock_executed_queries):
        ...
        with app.flask_app.test_client() as client:
            ...
            # We need to render this template manually since there's no direct route to it
            # Use Flask's render_template with mocked data
            import flask
            ...
            # Record original app context
            original_app = flask.current_app
